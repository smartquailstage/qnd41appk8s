...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='home',
            name='titulo',
            field=wagtail.fields.RichTextField(blank=True, verbose_name='titulo'),
        ),
        migrations.CreateModel(
            name='commingsoonform',
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='webapp.commingsoon')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
