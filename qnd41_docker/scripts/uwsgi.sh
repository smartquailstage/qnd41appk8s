...
python manage.py migrate --settings=qnd41app.settings.stage --noinput 
...
uwsgi --http :9000 --workers 9 --master --enable-threads --module qnd41_app_stg.wsgi  --ini uwsgi_stage.ini
